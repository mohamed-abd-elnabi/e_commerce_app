...
import 'package:shop_avatar/features/profile/presentation/controller/profile_controller.dart';
                ...
                children: [
                  ...
                  TextField(
                    decoration: InputDecoration(
                        prefixText: controller.appSettingsSharedPreferences
                            .getUserInfo()
                            .name,
                        label: Text(
                        ...
                        enabledBorder: UnderlineInputBorder(
                            borderSide:
                                BorderSide(color: ManagerColors.greyLight)),
                        focusedBorder: const UnderlineInputBorder(
                            borderSide:
                                BorderSide(color: ManagerColors.primaryColor)),
                        errorBorder: UnderlineInputBorder(
                            borderSide:
                                BorderSide(color: ManagerColors.error))),
                  ),
                  SizedBox(
